...
const permittedPngs = new Set([
  'authority/lucy-character-sheet-master.png',
  'v5/masters/lucy-zero.png',
  'v5/masters/lucy-heaven.png',
  'v5/masters/lucy-hell.png',
  'v5/masters/lucy-ultra.png',
]);
...
const pngViolations = files.filter((file) => file.type === 'png' && !permittedPngs.has(file.path)).map((file) => file.path);
...
const manifest = {
  ...
  pngPolicy: { permitted: [...permittedPngs], violations: pngViolations },

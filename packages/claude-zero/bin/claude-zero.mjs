#!/usr/bin/env node
// claude-zero launcher shim: runs ../src/cli.ts through tsx. Resolves tsx by
...
try {
  ...
  process.stderr.write("claude-zero: could not resolve tsx (is the package installed with its dependencies?)\n");
  process.exit(1);
}

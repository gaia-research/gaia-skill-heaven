// The agy-zero launch plan. Core owns every posture composition; this
// module resolves --skill paths, substitutes $SESSION, and carries core's
// verified plan back to the CLI. It never writes shared Antigravity state.
...
/** Plan a verified Antigravity launch grounded in ../PROBE.md. */

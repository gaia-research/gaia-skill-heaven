#!/usr/bin/env node
// agy-zero launcher shim: runs ../src/cli.ts through tsx. Resolves tsx by
...
try {
  ...
  process.stderr.write("agy-zero: could not resolve tsx (is the package installed with its dependencies?)\n");
  process.exit(1);
}

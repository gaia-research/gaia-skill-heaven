# Lucy Production Checklist

Legend: `[ ]` pending, `[x]` complete, `[!]` blocked after the one allowed call.

## Authority and workflow

- [x] Supplied character sheet, written canon, checklist, manifests, and JSON imported.
- [x] Canonical full PNG master retained as the only tracked Lucy PNG.
